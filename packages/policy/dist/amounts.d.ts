 ...
 */
export declare function parseSignedAmount(value: string): bigint | null;
/**
 ...
 */
export declare function parseUnsignedAmount(value: string): bigint | null;
/**
 ...
 */
export declare function outflowMagnitude(amount: bigint): bigint | null;

...
import { type Rule, type RuleId } from './rules.js';
 ...
 */
export declare function evaluate(effects: SimulatedEffects, policy: PolicyDoc, ledger: LedgerState): Decision;
/**
 ...
 */
export declare function evaluateWith(rules: readonly Rule[], effects: SimulatedEffects, policy: PolicyDoc, ledger: LedgerState): Decision;
/** The rule list minus one entry, for the mutation test. Returns a new array; `RULES` is frozen. */
export declare function rulesWithout(id: RuleId): readonly Rule[];

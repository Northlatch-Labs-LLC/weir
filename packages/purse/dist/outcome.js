 ...
 */
import { RULES } from '@projectx-social/policy';
/**
 ...
 * as the better fix.
 */
export function ruleIdIn(reason) {
    ...
    return POLICY_RULE_IDS.has(candidate) ? candidate : null;
}

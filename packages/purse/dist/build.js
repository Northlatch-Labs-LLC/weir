    ...
    try {
        switch (intent.kind) {
            ...
            case 'price': {
                ...
                owned(tx, intent.cap);
                builders.setContentPrice({ config: chain, tx }, {
        ...
        return refuse('intent-unbuildable', `the intent passed the schema and could still not be assembled into a transaction: ${detail}. ` +

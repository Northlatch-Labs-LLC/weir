 ...
 */
import { type RuleId } from '@projectx-social/policy';
/**
 ...
 */
export declare const PURSE_REFUSAL_IDS: readonly [
...
export declare function allow<T>(value: T): Outcome<T>;
export declare function refuse<T>(ruleId: RefusalId, reason: string): Outcome<T>;
/**
 ...
 * as the better fix.
 */
export declare function ruleIdIn(reason: string): RuleId | null;

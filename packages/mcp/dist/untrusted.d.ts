 ...
 */
export declare const UNTRUSTED_LEAD: string;
/**
 ...
 */
export declare const MAX_RESPONSE_CONTENT_CHARS: number;
/**
 ...
 */
export declare function envelope(input: {
 ...
 */
export declare function renderUntrusted(value: Record<string, unknown>): string;

 ...
 */
export function boundedPayment(tx, args) {
    /*
    ...
    */
    if (typeof args.ceiling !== 'bigint') {
        throw new Error(`boundedPayment needs a bigint ceiling in the coin's smallest unit; got ` +
    ...
    if (args.ceiling <= 0n) {
        throw new Error(`boundedPayment needs a positive ceiling; got ${args.ceiling.toString()}. A zero-funded ` +
    ...
    if (args.ceiling > MAX_U64) {
        throw new Error(`boundedPayment ceiling ${args.ceiling.toString()} exceeds u64. It cannot be represented ` +
...
//# sourceMappingURL=bound-coin.js.map
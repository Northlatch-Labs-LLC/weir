...
| **Content** | Posts, media, metadata; for gated posts, encrypted bodies we cannot read | You |
...
We use encryption in transit, access controls, and monitoring to protect the data we hold. Gated content is encrypted client-side before it reaches any storage. No system is perfectly secure; you are responsible for the security of your wallet, your seed phrase, and your Google account.

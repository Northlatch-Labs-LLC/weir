...
const GUARANTEES: readonly DesignGuarantee[] = [
  ...
  { icon: <Icon name="shield" size={18} />, title: 'Encrypted before it is stored', body: 'Paid bodies and media live on Walrus, encrypted. Seal releases the decryption key against the object in your wallet, so the paywall is enforced by key custody rather than by our server agreeing to say no.', mechanism: 'Seal keys · Walrus blobs · your object' },
  { icon: <Icon name="vault" size={18} />, title: 'No custody, by construction', body: 'A pooled deposit is delegated from a vault your address owns. We never take possession, so there is nothing for us to freeze, lend, rehypothecate or lose in a bankruptcy.', mechanism: 'no function exists that moves your principal' },

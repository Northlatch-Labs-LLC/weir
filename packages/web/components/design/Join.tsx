  ...
  */
  ...
  const yieldNote =
    joinYield === 0
      ...
      : `You give poolers back ${joinYield}% of the yield their deposit generates for you; you keep ${100 - joinYield}% as your own. The share is written on the vault object itself.`;

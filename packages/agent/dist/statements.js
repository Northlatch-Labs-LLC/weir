 ...
 */
export async function signAction(keypair, action, 
/**
 ...
 */
export function publishContentSha256(preview, text) {
 ...
 */
export function paidStatementFor(paid) {

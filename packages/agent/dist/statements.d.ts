 ...
 */
export declare function signAction(keypair: Ed25519Keypair, action: Action, 
/**
 ...
 */
origin: string, timestampMs?: number): Promise<SignedAction>;
/**
 ...
 */
export declare function publishContentSha256(preview: string, text: string): string;
/**
 ...
 */
export declare function paidStatementFor(paid: {
    handle: string;
    contentKey: string;
    price: string;
} | undefined): string;
